...
function onEvent(name, value1, value2)
	if name == 'blackall' and value1 == 'a' and hasSpawned == false then
		makeLuaSprite('whitebg', null, 0, 0)
		...
		doTweenColor('badapplexd100', 'iconP1', 'FFFFFF ', value2, 'linear')
		doTweenColor('badapplexd10', 'iconP2', 'FFFFFF ', value2, 'linear')
		hasSpawned = true
	end
	if name == 'blackall' and value1 == 'a' and hasSpawned == true then
		doTweenAlpha('applebadxd69', 'whitebg', 1, value2, 'linear')
		doTweenColor('badapplexd', 'boyfriend', '000000', value2, 'linear')
		doTweenColor('badapplexd1', 'dad', '000000', value2, 'linear')
		doTweenColor('badapplexd2', 'gf', '000000', value2, 'linear')
	...
	if name == 'blackall' and value1 == 'b' then
